...
import OrdersOverview from "./components/home/Orders";
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-10 mt-10">
        <Card>
          <div className="mt-6">
            ...
            <p className=" text-base text-textGreyCol"> <span className="font-semibold">30 done</span> this month.</p>
            <div className="overflow-x-scroll">
              <table className=" w-full py-3 mt-10 overflow-x-scroll ">
                <tr className="min-w-[120px] border-b-3 p-3 text-left">
                  {tableHeader.map((header) => (
                    <th className="uppercase pb-3">{header}</th>
                  ))}
                </tr>
